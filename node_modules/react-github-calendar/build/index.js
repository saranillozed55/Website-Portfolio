...
async function fetchGitHubData(username, year, signal) {
  const apiUrl = 'https://github-contributions-api.jogruber.de/v4/';
  const response = await fetch(`${apiUrl}${username}?y=${String(year)}&client=react-github-calendar`, {
    signal
  });
...
const GitHubCalendar = /*#__PURE__*/forwardRef(({
  ...
  useEffect(() => {
    ...
    fetchGitHubData(username, year, controller.signal).then(setData).catch(err => {
